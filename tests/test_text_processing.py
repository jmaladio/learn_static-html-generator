...
from text_processing import text_node_to_html_node, split_nodes_delimiter, extract_markdown_images, extract_markdown_links, split_nodes_image, split_nodes_link, text_to_textnodes
...
class TestSplitLinks(unittest.TestCase):
    def test_split_link(self):
        node = TextNode(
            "This is text with a [link](https://www.google.com) and another [link2](https://www.github.com)",
            TextType.TEXT,
        )
        ...
        self.assertListEqual(
            [
                ...
                TextNode(" and another ", TextType.TEXT),
                TextNode(
                    "link2", TextType.LINK, "https://www.github.com"
                ),
            ],
            new_nodes,
        )
